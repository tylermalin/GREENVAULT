    ...
    <div className="card-dark">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="kpi-card overflow-hidden">
          ...
          <p className="kpi-value text-lg md:text-xl lg:text-2xl break-all" title={formatNumber(totalCredits)}>
        ...
        <div className="kpi-card">
          ...
          <p className="text-xs text-light-gray mt-1 break-words overflow-hidden">
        ...
        <table className="w-full table-fixed">
          <thead>
            <tr className="border-b border-[#333333]">
              <th className="text-left py-3 px-4 text-sm font-semibold text-light-gray w-1/4">Project Name</th>
              <th className="text-left py-3 px-4 text-sm font-semibold text-light-gray w-20">Vintage</th>
              <th className="text-left py-3 px-4 text-sm font-semibold text-light-gray w-32">Registry</th>
              <th className="text-right py-3 px-4 text-sm font-semibold text-light-gray w-32">Quantity</th>
              <th className="text-right py-3 px-4 text-sm font-semibold text-light-gray w-32">Impact Score</th>
              <th className="text-center py-3 px-4 text-sm font-semibold text-light-gray w-28">Status</th>
            </tr>
          </thead>
          <tbody>
            {carbonCredits.map((credit) => (
              ...
              >
                <td className="py-3 px-4">
                  <span className="font-medium text-white break-words">{credit.projectName}</span>
                </td>
                <td className="py-3 px-4 text-sm text-light-gray">{credit.vintage}</td>
                <td className="py-3 px-4 text-sm text-light-gray break-words">{credit.registry}</td>
                ...
                <td className="py-3 px-4 text-right">
                  <div className="flex items-center justify-end space-x-1.5 min-w-0">
                    <div className="w-12 bg-[#333333] rounded-full h-2 flex-shrink-0">
                      <div
                ...
                <td className="py-3 px-4 text-center">
                  <div className="flex items-center justify-center space-x-1.5 min-w-0">
                    ...
                    <span className="text-sm capitalize text-light-gray whitespace-nowrap">
